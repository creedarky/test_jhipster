...
var cobranzaApp = angular.module('cobranzaApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'cobranzaAppUtils', 'pascalprecht.translate', 'truncate']);
